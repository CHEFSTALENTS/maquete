...
// 1) Courses / proximité
const GROCERIES = [
  "CARREFOUR CITY PARIS FR",
  "CARREFOUR MARKET LYON FR",
  "CARREFOUR  FR",
  "AUCHAN SUPERMARCHE LILLE FR",
  "AUCHAN TOULOUSE FR",
  "INTERMARCHE NANTES FR",
  "INTERMARCHE RENNES FR",
  "E.LECLERC FR",
  "E.LECLERC TOULOUSE FR",
  "E.LECLERC STRASBOURG FR",
  "MONOPRIX PARIS FR",
  "FRANPRIX PARIS FR",
  "FRANPRIX NICE FR",
  "CASINO SHOP MARSEILLE FR",
  "COOP ATLANTIQUE LA ROCHELLE FR",
  "PROXI U DIJON FR",
  "SUPER U ANGERS FR",
  "U EXPRESS MONTPELLIER FR",
  "LIDL MARSEILLE FR",
  "LIDL CLERMONT-FERRAND FR",
  "ALDI GRENOBLE FR",
  "BIOCOOP BORDEAUX FR",
  "BIOCOOP PARIS FR",
  "NATURALIA PARIS FR",
...
// 2) Boulangeries / cafés / snacking
const BAKERIES_CAFES = [
  "PAUL PARIS FR",
  "PAUL LILLE FR",
  "MAISON LANDEMAINE PARIS FR",
  "BOULANGERIE ANGE TOULOUSE FR",
  "BOULANGERIE LOUISE NANTES FR",
  "BOULANGERIE FEUILLETTE ANGERS FR",
  "ERIC KAYSER PARIS FR",
  "STARBUCKS PARIS FR",
  "STARBUCKS LYON FR",
  "COLUMBUS CAFE LILLE FR",
  "COSTA COFFEE NICE FR",
  "CAFETERIA UNIVERSITE RENNES FR",
  "SANDWICHERIE CENTRE VILLE STRASBOURG FR",
];

// 3) Restaurants “normaux” + quelques plaisirs
const RESTAURANTS = [
  "BISTROT DU COIN PARIS FR",
  "BRASSERIE DE LA PLACE LYON FR",
  "SUSHI SHOP PARIS FR",
  "SUSHI SHOP MARSEILLE FR",
  "POKE HOUSE LYON FR",
  "BIG FERNAND PARIS FR",
  "BIG FERNAND FR",
  "FIVE GUYS PARIS FR",
  "FIVE GUYS LILLE FR",
  "MCDONALD'S TOULOUSE FR",
  "MCDONALD'S NANTES FR",
  "BURGER KING MARSEILLE FR",
  "BURGER KING NICE FR",
  "KFC BORDEAUX FR",
  "KFC STRASBOURG FR",
  "FLUNCH LILLE FR",
  "COURTEPAILLE DIJON FR",
  "BUFFALO GRILL MONTPELLIER FR",
  "HIPPOPOTAMUS PARIS FR",
  "DEL ARTE RENNES FR",
  "VAPIANO PARIS FR",
  "LE RELAIS DE L’ENTRECOTE PARIS FR", // plaisir
  "BIG MAMMA PARIS FR", // plaisir
];

// 4) Transports / mobilité / péages
const TRANSPORTS = [
  "SNCF CONNECT",
  "RATP PARIS FR",
  "TCL LYON FR",
  ...
  "TISSÉO TOULOUSE FR",
  "IZILO RENNES FR",
  "KEOLIS STRASBOURG FR",
  "UBER TRIP PARIS FR",
  "UBER TRIP LYON FR",
  "BOLT TRIP PARIS FR",
  "G7 TAXI PARIS FR",
  "SIXT RENT A CAR NICE FR",
  "EUROPCAR FR",
  "AVIS TOULOUSE FR",
  "VINCI AUTOROUTES",
  "APRR AUTOROUTES",
...
const FUEL_PARKING = [
  ...
  "ESSO MARSEILLE FR",
  "AVIA NANTES FR",
  "CARREFOUR CARBURANT LILLE FR",
  "AUCHAN CARBURANT TOULOUSE FR",
  "E.LECLERC CARBURANT RENNES FR",
  "INDIGO PARKING PARIS FR",
  "Q-PARK LYON FR",
  "EFFIA PARKING GARE MONTPAR FR",
];

// 6) Pharmacie / santé / parapharmacie
const HEALTH = [
  "PHARMACIE DU CENTRE PARIS FR",
  "PHARMACIE DES HALLES LYON FR",
  "PHARMACIE VICTOIRE  FR",
  "PHARMACIE DE LA GARE LILLE FR",
  "PARAPHARMACIE E.LECLERC TOULOUSE FR",
  "PARAPHARMACIE AUCHAN NANTES FR",
  "DENTISTE CABINET MEDICAL RENNES FR",
  "LABORATOIRE ANALYSES MARSEILLE FR",
  "OPTIC 2000 NICE FR",
  "AFFLELOU FR",
];

// 7) Maison / bricolage / déco
const HOME_DIY = [
  "IKEA  FR",
  "IKEA LYON FR",
  "LEROY MERLIN TOULOUSE FR",
  "LEROY MERLIN NANTES FR",
  "CASTORAMA LILLE FR",
  "BRICO DEPOT MARSEILLE FR",
  "ACTION STRASBOURG FR",
  "GIFI DIJON FR",
  "MAISON DU MONDE PARIS FR",
  "CONFORAMA RENNES FR",
];

// 8) Shopping “normal” / vêtements
const SHOPPING = [
  "H&M PARIS FR",
  "ZARA LYON FR",
  "UNIQLO PARIS FR",
  "DECATHLON FR",
  "DECATHLON TOULOUSE FR",
  "FOOT LOCKER MARSEILLE FR",
  "FNAC PARIS FR",
  "FNAC NICE FR",
  "DARTY FR",
  "BOULANGER LYON FR",
...
// 9) Abonnements / digital / streaming
const SUBSCRIPTIONS = [
  "NETFLIX.COM",
  "SPOTIFY",
  "APPLE.COM/BILL",
...
// 10) E-commerce / livraison / “vie réelle”
const ECOM_DELIVERY = [
  "AMAZON FR",
  "CDiscount",
  "VEEPEE",
  "SHEIN.COM",
  "ZALANDO",
  "UBER EATS PARIS 01 FR",
  "UBER EATS 01 FR",
  "DELIVEROO LYON FR",
  "DELIVEROO LILLE FR",
  "JUST EAT TOULOUSE FR",
];

// 11) Voyages / weekends (occasionnels)
const TRAVEL = [
  "AIR FRANCE",
  "TRANSAVIA",
  "EASYJET",
...
const LUXURY = [
  ...
  "MAJE PARIS FR",
  "SANDRO PARIS FR",
  "ZADIG&VOLTAIRE PARIS FR",
  "LOUIS VUITTON PARIS", // très rare
];

// 13) Crypto / topups (optionnel)
const CRYPTO = [
  "REVOLUT TOPUP",
  "BINANCE.COM",
  "COINBASE",
